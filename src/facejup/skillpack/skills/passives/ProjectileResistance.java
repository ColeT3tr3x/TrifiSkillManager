...
public class ProjectileResistance extends Skill implements PassiveSkill{

	public ProjectileResistance(String name, String type, Material indicator, int maxLevel) {
		super(name, type, indicator, maxLevel);
		getDescription().add("&7Take %LEVEL*20% percent damage");
		getDescription().add("&7reduction from wither");
	}
