...
public class TwistedSight extends Skill implements PassiveSkill{

	public TwistedSight(String name, String type, Material indicator, int maxLevel) {
		super(name, type, indicator, maxLevel);
		getDescription().add("&bPassive");
		getDescription().add("&7Blind players who look at you");
	}
