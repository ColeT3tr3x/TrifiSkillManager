...
public class LightningBall extends Skill implements SkillShot {

	private HashMap<LivingEntity, Long> cooldown = new HashMap<>();
	public List<Projectile> balls = new ArrayList<>();
	...
	public LightningBall(String name, String type, Material indicator, int maxLevel) {
